...
//        fadeTransition.play();
        ...
        pane1.setStyle("-fx-background-image: url('calamardo.jpg')");
        pane2.setStyle("-fx-background-image: url('futurama.jpg')");
        pane3.setStyle("-fx-background-image: url('playmobil.jpg')");
        pane4.setStyle("-fx-background-image: url('PyF.jpg')");
